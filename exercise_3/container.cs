...
public abstract class Container (
    ...
    public double MassKG { get; set; } = verify_first_load(total_mass_kg - container_mass_kg, max_mass_kg);
    ...
    private static double verify_first_load(double cargo_mass_kg, double max_mass_kg) {
        if(cargo_mass_kg > max_mass_kg)
            throw new OverfillException(string.Format("Container is overfilled by {0}", cargo_mass_kg % max_mass_kg));
        return cargo_mass_kg;
    }
