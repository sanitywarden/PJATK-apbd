...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        // Fix: Apply Where first, then OrderByDescending
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var chicago_dept = depts
            .Where(d => d.Loc == "CHICAGO")
            .Select(d => d.DeptNo)
            .ToHashSet();

        var result = emps
            .Where(e => chicago_dept.Contains(e.DeptNo))
            .ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var average_by_departament = emps
            .GroupBy(e => e.DeptNo)
            .ToDictionary(g => g.Key, g => g.Average(e => e.Sal));

        var result = emps
            .Where(e => e.Sal > average_by_departament[e.DeptNo])
            .Select(e => e.EName)
            .ToList();
